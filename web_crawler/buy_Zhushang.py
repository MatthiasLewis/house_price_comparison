...
url = "https://www.hbhousing.com.tw/BuyHouse/{}"
...
for k,v in search_url.items():
    ...
    while True :
        ...
        for value in result:
            ...
            element = driver.find_element(By.XPATH, '//li/a[text()=">"]')
            actions = ActionChains(driver)
            actions.move_to_element(element).click().perform()
            time.sleep(randint(10,15))

    
    with open (f"buy_{k}.json","w",encoding="utf8") as f:
